...
public static class FirebaseDBLibrary
{
    ...
    [DllImport("__Internal")]
    public static extern void UpdateJSON(string path, string value, string objectName, string onSuccess, string onFailed);

    [DllImport("__Internal")]
    public static extern void UpdateKVJSON(string path, string key, string value, string objectName, string onSuccess, string onFailed);
